...
describe('chatHrefConstructor tests',()=>{
    test('if input ids are "alpha" and "beta", then the chatHREF is "alpha--beta"',()=>{
        expect(Utils.chatHrefConstructor("alpha", "beta")).toEqual("alpha--beta");
    });

    test('if input ids are "batman" and "robin", then the chatHREF is "batman--robin"',()=>{
        expect(Utils.chatHrefConstructor("batman", "robin")).toEqual("batman--robin");
    });

    test('if input ids are "robin" and "batman", then the chatHREF is sorted: "batman--robin"',()=>{
        expect(Utils.chatHrefConstructor("robin", "batman")).toEqual("batman--robin");
    });
})
